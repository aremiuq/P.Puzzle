...
if __name__ == "__main__":
    ...
    s.argprint("Protein Puzzler has begun!", verbose, quiet, 0)
    ...
    s.argprint("Parsing files...", verbose, quiet, 0)
    ...
    s.argprint("Protein Puzzler has finished!", s.options.verbose, s.options.quiet, 0)
